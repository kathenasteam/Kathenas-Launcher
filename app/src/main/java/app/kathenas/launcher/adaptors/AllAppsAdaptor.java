...
public class AllAppsAdaptor extends RecyclerView.Adapter<AllAppsAdaptor.MyViewHolder> {
    ...
    public AllAppsAdaptor(Context context,ArrayList<AppObject> data, OnItemClickListener onItemClickListener) {
